...
int sign=x>>31; //x的符号
x = (sign&~x)|(~sign&x);
/*如果x为正则不变,如果x为负则按位取反,因为要去掉符号位
计算剩下需要几位,最后return值有+1,不影响
例如1111 1111 1111 1111 1111 1111 1111 1101表示-3,其按位取反得0000 0000 0000
0000 0000 0000 0000 0010
计算b16+b8+b4+b2+b1+b0=2,return 2+1=3,即-3最少需要3位比特位表示补码(相当
101)*/
// 不断缩小范围
